...
achieves a mean detection rate of \textbf{86.3\%} {[}95\% CI: 43.2\%,
...
at \(+0.050\) beyond additive---is roughly an order of magnitude smaller
...
by the 950-attack corpus scope. The 10--11 percentage-point gap between
