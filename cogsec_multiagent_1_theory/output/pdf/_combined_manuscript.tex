...
\makeatother
\hypersetup{
  pdftitle={Cognitive Integrity Framework: Formal Foundations (Second Edition)},
  pdfauthor={Daniel Ari Friedman},
  colorlinks=true,linkcolor=red,urlcolor=red,citecolor=red,anchorcolor=red,filecolor=red,
  pdfcreator={LaTeX via pandoc}}

\title{Cognitive Integrity Framework: Formal Foundations (Second
Edition)}
\author{Daniel Ari Friedman}
\date{}

\title{Cognitive Integrity Framework: Formal Foundations (Second Edition)}
...
\centering
\vspace*{2cm}
{\LARGE\bfseries Cognitive Integrity Framework: Formal Foundations (Second Edition)\par}
\vspace{0.75em}
{\large Part 1 of 3: Theoretical Foundations — v2.0 Revised and Expanded\par}
\vfill
\makeatletter
{\@author\par}
\vspace{1em}
...
simulation across 950 attacks and six production architectures; Part 3
...
the merged Part 3 \cite{friedman2026cogsec3}.
...
simulation across 950 attack vectors and six production architectures.
...
\textbf{Part 3: Practitioner Guidance \& Applications} The merged third
companion paper
...
ceiling of 94--100\% detection rate on a 950-attack corpus across six
...
Attack $\mathcal{A}$ with $D_{\mathrm{KL}}(P_{\text{attack}} \| P_{\text{benign}}) < \frac{4epsilon^2}{1}$ is $epsilon$-undetectable for any detector observing fewer than $n^* = O(1/D_{\mathrm{KL}})$ samples.
\end{theorem}
...
\subsection{Formal Limitations}\label{sec:limitations}
...
mapping, we refer the reader to \textbf{Part 3: Practitioner Guidance \&
...
\subsection{v2.0 New Proofs: Defense Composition Algebra and
...
Wait---the bound $pi/2$ arises from the maximum attack at the hemisphere boundary. For attacks with $r < pi$, the product $\mathcal{I} \cdot \mathcal{S}$ is bounded when $\mathcal{S}$ is defined relative to the detectable threshold $theta_{\text{drift}}$:
