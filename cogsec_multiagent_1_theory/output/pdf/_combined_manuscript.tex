...
points under the Neyman-Pearson framework; the curves themselves are
labeled Theoretical, not empirical measurements).}\label{fig:roc-curves}
\end{figure}
