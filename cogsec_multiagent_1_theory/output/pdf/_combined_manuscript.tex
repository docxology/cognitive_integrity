...
sharper answer than a ranked list. On the 98-attack ablation corpus a
...
studies in which the strongest pairwise synergy---Firewall + Detection,
at \(+0.031\) beyond additive---is roughly an order of magnitude smaller
than the leave-one-out contribution of the single dominant module, so on
that corpus independence is neither confirmed nor cleanly refuted; (3)
...
by the 950-attack corpus scope. The 4--51 percentage-point gap between
