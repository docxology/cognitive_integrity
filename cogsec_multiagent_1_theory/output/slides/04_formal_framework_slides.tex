...
\begin{frame}[allowframebreaks]{Trust Calculus}
...
Coupling}
\protect\phantomsection\label{sec:cif-ad-coupling}
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth,height=0.46\textheight,keepaspectratio,alt={CIF-AD action--delegation coupling matrix showing how Functional Requirements map to Design Parameters and delegation actions, making explicit where a Goal-Hijacking transient can introduce off-diagonal coupling.}]{../figures/cif_ad_coupling.pdf}
...
\begin{block}{The Action-Delegation Cycle}
...
\begin{block}{CIF-AD Coupling Matrix}
...
\protect\phantomsection\label{sec:cif-ooda}
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth,height=0.46\textheight,keepaspectratio,alt={CIF-OODA phase diagram mapping the defense mechanisms onto the Observe--Orient--Decide--Act cycle, indicating at which phase each defense intervenes and its latency budget.}]{../figures/ooda_phase_diagram.pdf}
...
\begin{block}{OODA Loop Formalization}
...
\begin{block}{Phase-Specific Attack Taxonomy}
...
\begin{block}{OODA Temporal Coupling}
...
\begin{block}{Integrative Security Guarantee}
