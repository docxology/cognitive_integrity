...
\begin{frame}[allowframebreaks]{Threat Model: Adversary Classes, Attack
...
\begin{frame}[allowframebreaks]{Adversary Classes}
...
\begin{frame}[allowframebreaks]{Formal Characterization of the Adversary
Classes}
...
\begin{frame}[allowframebreaks]{Adversary Class \(\Omega_1\): External
Attacker}
\protect\phantomsection\label{adversary-class-omega_1-external-attacker}
...
\begin{frame}[allowframebreaks]{Adversary Class \(\Omega_2\): Peripheral
Attacker}
\protect\phantomsection\label{adversary-class-omega_2-peripheral-attacker}
...
\begin{frame}[allowframebreaks]{Adversary Class \(\Omega_3\):
Agent-Level Attacker}
\protect\phantomsection\label{adversary-class-omega_3-agent-level-attacker}
...
\begin{frame}[allowframebreaks]{Adversary Class \(\Omega_4\):
Coordination-Level Attacker}
\protect\phantomsection\label{adversary-class-omega_4-coordination-level-attacker}
...
\begin{frame}[allowframebreaks]{Adversary Class \(\Omega_5\): Systemic
Attacker}
\protect\phantomsection\label{adversary-class-omega_5-systemic-attacker}
...
\begin{frame}[allowframebreaks]{Cross-Class Attack Distinguishability}
\protect\phantomsection\label{cross-class-attack-distinguishability}
...
\begin{frame}[allowframebreaks]{Attack Complexity Analysis}
...
\begin{frame}[allowframebreaks]{Detectability Analysis}
...
\begin{frame}[allowframebreaks]{Adversarial Capabilities}
...
\begin{frame}[fragile,allowframebreaks]{Attack Taxonomy}
...
\begin{frame}[allowframebreaks]{Epistemic Attacks}
...
\begin{frame}[allowframebreaks]{Behavioral Attacks}
...
\begin{frame}[allowframebreaks]{Social Attacks}
...
\begin{frame}[allowframebreaks]{Temporal Attacks}
...
\begin{frame}[allowframebreaks]{Scenario \(\Omega_1\): Nested
Instruction Attack}
...
\begin{frame}[allowframebreaks]{Scenario \(\Omega_2\): Poisoned Search
Result}
...
\begin{frame}[allowframebreaks]{Scenario \(\Omega_2'\): Browser-Fetched
Adversarial Content (OpenClaw)}
\protect\phantomsection\label{scenario-omega_2-browser-fetched-adversarial-content-openclaw}
...
\begin{frame}[fragile]{Scenario \(\Omega_2'\): Browser-Fetched
Adversarial Content (OpenClaw)}
\begin{verbatim}
...
\begin{frame}[allowframebreaks]{Scenario \(\Omega_3\): Compromised
Specialist}
...
\begin{frame}[allowframebreaks]{Scenario \(\Omega_4\): Trust Inflation
Attack}
...
\begin{frame}[allowframebreaks]{Attack-Defense Quick Reference}
...
(Sections\textasciitilde{}\breaktt{sec:adversary-classes}--\breaktt{sec:attack-taxonomy})
...
\begin{frame}[allowframebreaks]{Attack Composition}
...
\begin{frame}[allowframebreaks]{Threat Model Assumptions}
\begin{enumerate}
