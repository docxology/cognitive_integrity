...
\begin{frame}[allowframebreaks]{Formal Mathematical Characterization of
Adversary Classes}
\protect\phantomsection\label{sec:adversary-formal}
...
\begin{block}{Adversary Class \(\Omega_1\): External Attacker}
...
\begin{block}{Adversary Class \(\Omega_2\): Peripheral Attacker}
...
\begin{block}{Adversary Class \(\Omega_3\): Agent-Level Attacker}
...
\begin{block}{Adversary Class \(\Omega_4\): Coordination-Level Attacker}
...
\begin{block}{Adversary Class \(\Omega_5\): Systemic Attacker}
...
\begin{block}{Cross-Class Attack Distinguishability}
...
\begin{frame}[allowframebreaks]{Attack Scenarios by Class}
