...
isolation \breakseq{[@perez2022red; @wei2023jailbroken]}. Even recent
...
individual capacity \breakseq{[@wilson1971insect]}. The colony's cognitive
...
\breakseq{[@grasse1959reconstruction]}. Ants deposit pheromones; bees perform
...
individual's cognitive capacity \breakseq{[@bonabeau1999swarm]}.
...
bees \breakseq{[@lenoir2001chemical]}. These systems implement implicit trust
calculi.
...
\breakseq{[@currie2006coevolved]}. \emph{AI analog}: Architectural isolation of
...
infection \breakseq{[@konrad2012social]}. \emph{AI analog}: Controlled exposure
...
exact matching \breakseq{[@lenoir2001chemical]}. This creates a tradeoff:
...
\breakseq{[@fernandez2006evolution]}. \emph{AI analog}: Environmental-level
...
\breakseq{[@jackson2006communication]}. \emph{AI analog}: Time-bounded trust in
...
\breakseq{[@breed2004division]}. \emph{AI analog}: Graduated response to
...
\breakseq{[@spivak2001hygienic]}. \emph{AI analog}: Proactive monitoring for
...
information \breakseq{[@gruter2008dance]}. \emph{AI analog}: Delegated
...
\breakseq{[@schneider2001economics]}. \emph{AI analog}: Graceful degradation
...
\breakseq{[@simone2009resin]}. Notably, colonies under disease pressure collect
...
\breakseq{[@kilner2011cuckoos]}.
\end{block}
\end{frame}

\begin{frame}[allowframebreaks]{The Benchmark Gap}
...
\midrule\noalign{}
\endhead
HarmBench \breakseq{[@mazeika2024harmbench]} & Single model, harmful output &
None \\
JailbreakBench \breakseq{[@chao2024jailbreakbench]} & Single model, constraint
bypass & None \\
TrustLLM \breakseq{[@sun2024trustllm]} & Single model, trust dimensions &
None \\
AgentBench \breakseq{[@liu2023agentbench]} & Single agent, task completion &
Minimal \\
GAIA \breakseq{[@mialon2023gaia]} & Single/few agents, reasoning & Minimal \\
\bottomrule\noalign{}
\end{longtable}
}
...
\begin{frame}[allowframebreaks]{This scaling effect explains why large
...
\item
  ...
  \breakseq{[@debout2007polydomy]}. How should trust decay and information
...
\item
  ...
  information is verified \breakseq{[@seeley2010honeybee]}. \emph{AI analog}:
...
\item
  ...
  influence \breakseq{[@sendova2010social]}. \emph{AI analog}: Can analysis of
...
\item
  ...
  sources \breakseq{[@wilson1958chemical]}. \emph{AI analog}: Automated
...
\item
  ...
  \breakseq{[@lorenzi2011nestmate]}. \emph{AI analog}: How do we prevent
...
\item
  ...
  depending on context \breakseq{[@vander1998alarm]}. \emph{AI analog}:
...
\item
  ...
  \breakseq{[@waters2010metabolism]}. \emph{AI analog}: Resource allocation
...
\begin{frame}[allowframebreaks]{Proofs}
