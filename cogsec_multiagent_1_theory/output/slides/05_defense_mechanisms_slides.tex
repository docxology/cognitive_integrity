...
\begin{frame}[allowframebreaks]{Architectural Defenses}
...
\begin{frame}[allowframebreaks]{Runtime Defenses}
...
\begin{frame}[allowframebreaks]{Coordination Defenses}
...
\begin{figure}
\centering
\includegraphics[width=0.8\linewidth,height=0.46\textheight,keepaspectratio,alt={Schematic ablation study (illustrative, not measured): representative marginal contribution of each CIF defense module to the composed defense. Measured ablation results are reported in Part 2.}]{../figures/ablation_study.pdf}
...
\protect\phantomsection\label{sec:defense-formal-guarantees}
...
Section\textasciitilde{}\ref{sec:defense-composition} with complete
proofs and explicit security bounds.}

\begin{block}{Canonical Defense 1: Cognitive Firewall --- Formal
Specification}
...
\begin{block}{Canonical Defense 2: Belief Sandboxing --- Formal
Specification}
...
\begin{block}{Canonical Defense 3: Behavioral Invariants --- Formal
Specification}
...
\begin{block}{Canonical Defense 4: Drift Detection --- Formal
Specification}
...
\begin{block}{Canonical Defense 5: Byzantine Consensus --- Formal
Specification}
...
\begin{block}{Defense Composition Algebra: Complete Specification}
