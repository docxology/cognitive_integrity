...
\begin{frame}[allowframebreaks]{Empirical Validation Summary}
\protect\phantomsection\label{empirical-validation-summary}
...
\begin{frame}[allowframebreaks]{Theoretical Implications}
...
\begin{frame}[allowframebreaks]{Formal Limitations}
...
\begin{frame}[allowframebreaks]{Governance and Policy Implications}
...
\begin{frame}[allowframebreaks]{Future Theoretical Directions}
