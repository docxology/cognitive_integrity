...
\begin{frame}[allowframebreaks]{Multi-Detector Fusion}
...
\begin{frame}[allowframebreaks]{Online vs.~Batch Detection}
...
\begin{figure}
\centering
\includegraphics[width=0.8\linewidth,height=0.46\textheight,keepaspectratio,alt={False-positive mitigation (illustrative schematic): how the detection threshold and confidence calibration shape the false-positive / true-positive tradeoff.}]{../figures/fp_mitigation.pdf}
...
\begin{frame}[allowframebreaks]{Provenance Analysis}
...
\begin{frame}[allowframebreaks]{Real-Time Monitoring}
...
\protect\phantomsection\label{sec:it-detection-limits}
...
\begin{block}{Neyman-Pearson Detection Framework}
...
\begin{block}{Chernoff Information and Error Exponents}
...
\begin{block}{KL Divergence and Detection Rate Coupling}
...
\begin{block}{Fundamental Undetectability Regime}
...
\begin{block}{Adaptive Threshold Selection}
