...
\begin{frame}[allowframebreaks]{Supplementary: Notation Reference}
...
\begin{frame}[allowframebreaks]{Adversary Model Notation}
...
\begin{frame}[allowframebreaks]{System Model Notation}
...
\begin{frame}[allowframebreaks]{Trust Calculus Notation}
...
\begin{frame}[allowframebreaks]{Defense Mechanism Notation}
...
\begin{frame}[allowframebreaks]{Detection \& Analysis Notation}
...
\begin{frame}[allowframebreaks]{Consensus \& Coordination Notation}
...
\begin{frame}[allowframebreaks]{Cost \& Performance Notation}
...
\begin{frame}[allowframebreaks]{Information \& Complexity Notation}
...
\begin{frame}[allowframebreaks]{Stigmergic \& Colony Notation
(Supplementary)}
...
\begin{frame}[allowframebreaks]{General Mathematical Notation}
...
\begin{frame}[allowframebreaks]{CTL Temporal Logic Notation (Formal
Verification)}
