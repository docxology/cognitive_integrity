...
\begin{frame}[allowframebreaks]{Trust Boundedness}
...
\begin{frame}[allowframebreaks]{Belief Injection Resistance}
...
\begin{frame}[allowframebreaks]{No Trust Amplification}
...
\begin{frame}[allowframebreaks]{Goal Alignment Invariant}
...
\begin{frame}[allowframebreaks]{Firewall Liveness}
...
\begin{frame}[allowframebreaks]{Byzantine Consensus Termination}
...
\begin{frame}[allowframebreaks]{Bounded Overhead}
