...
\begin{frame}[allowframebreaks]{Preliminary Definitions and Notation}
...
\protect\phantomsection\label{sec:thm42-proof}
...
Resistance}
\protect\phantomsection\label{sec:thm57-proof}
...
\protect\phantomsection\label{sec:thm47-proof}
...
\protect\phantomsection\label{sec:thm58-proof}
...
\protect\phantomsection\label{sec:thm59-proof}
...
Termination}
\protect\phantomsection\label{sec:thm510-proof}
...
\protect\phantomsection\label{sec:thm511-proof}
...
\begin{frame}[allowframebreaks]{v1.1 New Proofs: Defense Composition
Algebra and Information-Geometric Bounds}
\protect\phantomsection\label{sec:v2-proofs}
...
\begin{frame}[allowframebreaks]{Theorem: Defense Composition Semiring}
\protect\phantomsection\label{sec:thm-composition-semiring}
...
\begin{frame}[allowframebreaks]{Theorem: Information-Geometric
Stealth-Impact Tight Bound}
\protect\phantomsection\label{sec:thm-geometric-bound}
...
\begin{frame}[allowframebreaks]{Theorem: Agent Compromise Blast Radius}
\protect\phantomsection\label{sec:thm-blast-radius}
...
\protect\phantomsection\label{sec:proof-summary-v2}
\begin{table}[htbp]
\centering
