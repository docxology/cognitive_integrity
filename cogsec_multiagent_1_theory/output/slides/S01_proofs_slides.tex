...
\begin{frame}[allowframebreaks]{Supplementary: Mathematical Proofs}
...
\begin{frame}[fragile,allowframebreaks]{Proof Status}
...
\begin{frame}[allowframebreaks]{Notation Summary}
...
\begin{frame}[allowframebreaks]{Theorem 4.2: Trust Boundedness}
...
\begin{frame}[allowframebreaks]{Theorem 5.7: Belief Injection
Resistance}
...
\begin{frame}[allowframebreaks]{Theorem 4.7: No Trust Amplification}
...
\begin{frame}[allowframebreaks]{Theorem 5.8: Goal Alignment Invariant}
...
\begin{frame}[allowframebreaks]{Theorem 5.9: Firewall Liveness}
...
\begin{frame}[allowframebreaks]{Theorem 5.10: Byzantine Consensus
Termination}
...
\begin{frame}[allowframebreaks]{Theorem 5.11: Bounded Overhead}
...
\begin{frame}[allowframebreaks]{Numerical Instantiation}
...
\begin{frame}[allowframebreaks]{Additional Lemmas}
...
\begin{frame}[allowframebreaks]{Summary of Proof Techniques}
\begin{table}[htbp]
\centering
...
\begin{frame}[allowframebreaks]{Second-Edition Proofs: Defense
Composition Algebra and Information-Geometric Bounds}
This section contains new proofs added in the Second Edition,
corresponding to the defense composition algebra guarantees
(§5.7) and the information-geometric
tightening of the stealth-impact bound (§4.5).
\end{frame}
...
\begin{frame}[allowframebreaks]{The Defense Composition Algebra}
...
\begin{frame}[allowframebreaks]{The Tight Information-Geometric
Stealth-Impact Bound}
...
\begin{frame}[allowframebreaks]{The Agent Compromise Blast Radius Bound}
...
\begin{frame}[allowframebreaks]{Updated Summary of Proof Techniques}
\begin{table}[htbp]
\centering
