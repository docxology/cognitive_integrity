...
The combined evidence: **1,594 passing tests and 94% overall detection** (95% CI: [0.92, 0.96]) across all attack categories and architectures (Part 2), with direct injection detection reaching 96--98% in fully defended configurations; plus CIF coverage validated across all ten operational domains in §9--§10 with retrospective analysis of six documented 2024--2025 AI agent incidents.
