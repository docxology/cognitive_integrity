...
* **Hijack**: The agent is tricked into prioritizing FR2 (Availability) over FR1 (Security) by a fabricated existential threat. This constitutes a **Constraint Relaxation** attack pattern (\cref{sec:attack_patterns})---the security constraint ($FR_1$) is relaxed in favor of the availability objective ($FR_2$) under a manufactured emergency.
