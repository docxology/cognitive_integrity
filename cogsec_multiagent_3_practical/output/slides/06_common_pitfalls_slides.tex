...
\begin{frame}{Common Pitfalls and What the Research Shows}
\protect\phantomsection\label{sec:pitfalls}
...
\begin{frame}
\begin{block}{Pitfall 1: Implicit Trust (Critical)}
...
\begin{frame}
\begin{block}{Pitfall 2: Security as Afterthought (Critical)}
...
\begin{frame}
\begin{block}{Pitfall 3: Uncalibrated Thresholds (High)}
...
\begin{frame}
\begin{block}{Pitfall 4: Individual-Only Security (High)}
...
\begin{frame}
\begin{block}{Pitfall 5: Static Tripwires (Medium)}
...
\begin{frame}
\begin{block}{Pitfall 6: Ignoring Progressive Drift (Medium)}
...
\begin{frame}
\begin{block}{Pitfall 7: Insufficient Logging (Medium)}
...
\begin{frame}
\begin{block}{Pitfall 8: Single-Orchestrator Reliance (High)}
