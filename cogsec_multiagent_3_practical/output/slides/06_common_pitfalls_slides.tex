...
\begin{figure}
\centering
\includegraphics[width=0.8\linewidth,height=0.46\textheight,keepaspectratio,alt={Common pitfalls by severity across security/configuration/operational categories (e.g.~implicit trust in outputs, missing input validation).}]{../figures/pitfall_severity.png}
