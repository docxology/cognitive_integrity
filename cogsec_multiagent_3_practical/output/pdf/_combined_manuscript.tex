...
adapter-maturity improvement described in Partabout 2.
...
72\% detection rate reflects the gap between parametric ceiling
(96--100\%) and real deployment. Targeted threshold tuning closes part
of this gap without full retraining --- a pragmatic first response that
buys time for a proper model update.
