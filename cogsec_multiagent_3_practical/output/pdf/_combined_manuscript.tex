...
far less evenly than the model implies: on Part 2's 98-attack ablation
...
the 98-attack ablation corpus says so plainly. The Invariants module
...
The 4--51 percentage-point gap between the parametric ceiling
...
parametric floor to the 30-seed pipeline mean of 44.8\%. The narrow end
is the distance from the top of the parametric range to the 95.9\% the
same pipeline now reaches on the 98-attack ablation corpus --- a figure
...
\item
  \textbf{95.9\%} (98-attack ablation corpus, all categories including
...
\item
  ...
  on Partabout 2's 98-attack ablation corpus the Invariants
