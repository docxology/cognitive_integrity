...
\vspace{0.08em}
{\small\sffamily DOI: \href{https://doi.org/10.5281/zenodo.18364130}{10.5281/zenodo.18364130}\par}
\vspace{0.35em}
\makeatletter
{\@date\par}
\makeatother
...
detects 85\% of that corpus against the full stack's 89.0\%; the
Detection, Sandbox, Tripwire and Consensus modules each detect between
4\% and 6\% on their own. Removing Invariants costs 65 percentage points
of true-positive rate, removing the Tripwire costs two, and removing
...
\tightlist
\item
  \textbf{99.4\% Overall Detection} means: ``Across all architectures
  and attack categories, 99.4\% of attack vectors are detected by the
  full CIF defense stack'' (with architecture-specific rates ranging
  from 96--100\%).
\item
  It does \textbf{not} mean: ``We have a magic Python script that
  catches 99.4\% of all evil AI thoughts.''
\end{itemize}
...
\item
  ...
  10.5281/zenodo.18364119) establishes the Cognitive Integrity Framework
...
\item
  ...
  (DOI: 10.5281/zenodo.18364128) validated these mechanisms
...
\item
  ...
  \cite{friedman2026cogsec3} (DOI: 10.5281/zenodo.18364130) translates
...
10.5281/zenodo.18364128) provides a composable visualization engine ---
...
\item
  ...
  \cite{friedman2026cogsec3} (DOI: 10.5281/zenodo.18364130, this paper)
