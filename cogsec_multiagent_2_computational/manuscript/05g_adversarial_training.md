...
of per-class performance. They are therefore not tabulated here, and this section retains its label so
that cross-references from the rest of the series resolve.
