...
\begin{theorem}[Series Composition as Categorical Composition]\label{thm:series-categorical}
...
\begin{theorem}[Categorical Product, CT.2]\label{thm:categorical-product}
...
\begin{theorem}[Attack-FEP Equivalence, FEP.1]\label{thm:attack-fep}
...
\begin{theorem}[CIF Nash Equilibrium, GT.1]\label{thm:cif-nash}
