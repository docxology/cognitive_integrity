...
The parametric analysis identifies the following parameter configuration as F1-maximizing. These values are used as defaults in the real pipeline evaluation:
