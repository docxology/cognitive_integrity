...
def main() -> None:
    ...
    print(f"\nMinimal forward:  {results['minimal_forward']['components']} (TPR={results['minimal_forward']['tpr']:.4f})")
    print(f"Minimal backward: {results['minimal_backward']['components']} (TPR={results['minimal_backward']['tpr']:.4f})")
