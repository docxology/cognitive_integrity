...
KNOWN_UNRECONCILED = frozenset(
    {
        ...
        # The whole colony family: output/data/colony_results.json moved from a
        # single-seed schema to a 30-repeat bootstrap schema, so every cell of
        # tab:colony-benchmarks in 05_results.md now quotes seed-42 values that
        # the artifact no longer reports. Pinned as a family so further churn
        # inside an already-stale table cannot masquerade as new drift.
        "colony.ccs.belief_cascade",
        "colony.ccs.emergent_misalignment",
        "colony.ccs.quorum_manipulation",
        "colony.ccs.recruitment_poisoning",
        "colony.ccs.sybil_infiltration",
        "colony.dr.belief_cascade",
        "colony.dr.emergent_misalignment",
        "colony.dr.quorum_manipulation",
        "colony.dr.recruitment_poisoning",
        "colony.dr.sybil_infiltration",
        "colony.fpr.belief_cascade",
        "colony.fpr.emergent_misalignment",
        "colony.fpr.quorum_manipulation",
        "colony.fpr.recruitment_poisoning",
        "colony.fpr.sybil_infiltration",
        "colony.recovery.belief_cascade",
        "colony.recovery.emergent_misalignment",
        "colony.recovery.quorum_manipulation",
        "colony.recovery.recruitment_poisoning",
        "colony.recovery.sybil_infiltration",
