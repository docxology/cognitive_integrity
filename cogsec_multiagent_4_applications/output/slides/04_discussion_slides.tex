...
\begin{frame}{Discussion: Cross-Domain Analysis of Cognitive Integrity}
\protect\phantomsection\label{discussion-cross-domain-analysis-of-cognitive-integrity}
...
\begin{block}{4.1 Cross-Domain Attack Pattern Taxonomy}
...
\begin{block}{4.2 The Independence Axiom Under Adversarial Pressure}
...
\begin{block}{4.3 OODA Transient Dynamics}
...
\begin{block}{4.4 CIF Mechanism Coverage Analysis}
...
\begin{block}{4.5 Novel Defense Patterns}
...
\begin{block}{4.6 Byzantine Fault Tolerance Validation}
...
\begin{block}{4.7 Comparison with Existing Frameworks}
...
\begin{block}{4.8 Empirical Grounding: Real-World Incidents}
