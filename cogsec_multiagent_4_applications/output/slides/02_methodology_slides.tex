...
\begin{frame}{Methodology: The CIF-AD-OODA Integration Model}
...
\begin{block}{Framework Integration}
...
\begin{block}{CIF Defense Mechanisms}
...
\begin{block}{Adversary Classification}
...
\begin{block}{Domain Analysis Template}
...
\begin{block}{Domain Selection Criteria}
...
\begin{block}{Scope and Assumptions}
...
\begin{block}{Application to Critical Domains}
